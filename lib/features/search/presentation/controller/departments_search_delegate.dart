...
class DepartmentsSearchDelegate extends SearchDelegate<String> {
  @override
  ...
  Widget buildResults(BuildContext context) {
    late final departmentSearchProvider = FutureProvider((ref) async {
      final client = await ref.getDebouncedHttpClient();
      return DepartmentRepository(localClient: client).searchDepartments(
        query: query,
      );
    });
    print("buildResults triggered with query: $query");
    return Consumer(builder: (context, ref, child) {
      final searchResults = ref.watch(departmentSearchProvider);
